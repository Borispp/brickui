...
import { verifyChangeEmail } from 'components/organismes/ProfileForm/store/actions';
import { updateUserStatus } from 'modules/account/actions';
...
class VerificationPage extends PureComponent {
  componentDidMount = async () => {
    ...
    await this.props.verifyChangeEmail({ userId, token });
